    ...
    <table class="w-full">
        <thead class="bg-stone-50 border-b border-stone-200">
            <tr>
                ...
                <th class="text-left px-4 py-3 text-sm font-medium text-stone-600">Телефон</th>
            ...
            @forelse($messages as $msg)
                <tr class="border-b border-stone-100 hover:bg-stone-50/50">
                    <td class="px-4 py-3 text-sm text-stone-600">
                        <a href="{{ route('admin.contacts.show', $msg) }}" class="text-stone-800 hover:text-amber-600 font-medium">
                            {{ $msg->name }}
                        </a>
                    </td>
